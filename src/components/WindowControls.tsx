...
const WindowControls = () => {
  ...
  return (
    <div 
      className="flex items-center gap-2 z-[999999] pointer-events-auto"
      style={{ WebkitAppRegion: 'no-drag' } as any}
    >
      <button
        onClick={handleMinimize}
        className="w-8 h-8 flex items-center justify-center rounded-lg liquid-glass hover:bg-white/10 transition-all group pointer-events-auto cursor-pointer"
        title="Minimize"
      >
      ...
      <button
        onClick={handleClose}
        className="w-8 h-8 flex items-center justify-center rounded-lg liquid-glass hover:bg-destructive/20 hover:border-destructive/40 transition-all group pointer-events-auto cursor-pointer"
        title="Close"
      >
